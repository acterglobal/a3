...
fn report_bug(url: string, username: string, password: Option<string>, app_name: string, version: string, text: string, label: string, with_log: bool, screenshot_path: Option<string>) -> Future<Result<bool>>;
