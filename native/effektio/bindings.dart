...
class Api {
  ...
  Client newClient(
    ...
    final tmp14_1 = _Box(this, tmp14_0, "drop_box_Client");
    tmp14_1._finalizer = this._registerFinalizer(tmp14_1);
    final tmp9 = Client._(this, tmp14_1);
    return tmp9;
  }
  ...
  late final _newClientPtr = _lookup<
      ffi.NativeFunction<
          _NewClientReturn Function(
    ffi.Int64,
    ffi.Uint64,
    ffi.Uint64,
    ffi.Int64,
  ...
  late final _newClient = _newClientPtr.asFunction<
      _NewClientReturn Function(
    int,
    int,
    int,
...
class _NewClientReturn extends ffi.Struct {
  @ffi.Uint8()
  external int arg0;
  @ffi.Int64()
  external int arg1;
