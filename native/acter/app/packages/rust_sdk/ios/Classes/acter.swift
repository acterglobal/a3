...
public struct NotificationItem {
    ...
    public init(roomId: String, senderDisplayName: String?, senderAvatarUrl: String?, roomDisplayName: String, roomAvatarUrl: String?, roomCanonicalAlias: String?, isRoomEncrypted: Bool?, isDirectMessageRoom: Bool, joinedMembersCount: UInt64, isNoisy: Bool?) {
        self.roomId = roomId
