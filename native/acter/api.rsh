...
object NewsEntryDraft {
    ...
    fn add_image_slide(body: string, uri: string, width: Option<u32>, height: Option<u32>, blurhash: Option<string>) -> Future<Result<bool>>;

    /// create news slide for audio msg
    fn add_audio_slide(body: string, uri: string, secs: Option<u32>) -> Future<Result<bool>>;

    /// create news slide for video msg
    fn add_video_slide(body: string, uri: string, secs: Option<u32>, width: Option<u32>, height: Option<u32>, blurhash: Option<string>) -> Future<Result<bool>>;
...
object Convo {
    ...
    fn edit_image_message(event_id: string, uri: string, name: string, width: Option<u32>, height: Option<u32>) -> Future<Result<EventId>>;
    ...
    fn edit_audio_message(event_id: string, uri: string, name: string, secs: Option<u32>) -> Future<Result<EventId>>;

    /// send the video message to this room
    fn send_video_message(uri: string, name: string, secs: Option<u32>, width: Option<u32>, height: Option<u32>, blurhash: Option<string>) -> Future<Result<EventId>>;
    ...
    fn edit_video_message(event_id: string, uri: string, name: string, secs: Option<u32>, width: Option<u32>, height: Option<u32>) -> Future<Result<EventId>>;
