...
void main() {
  final EffektioFlutterSdkPlatform initialPlatform = EffektioFlutterSdkPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    EffektioFlutterSdk effektioFlutterSdkPlugin = EffektioFlutterSdk();
    MockEffektioFlutterSdkPlatform fakePlatform = MockEffektioFlutterSdkPlatform();
    EffektioFlutterSdkPlatform.instance = fakePlatform;

    expect(await effektioFlutterSdkPlugin.getPlatformVersion(), '42');
  });
}
