...
void main() {
  group('SpaceActivitiesItemWidget Tests', () {
    ...
    setUp(() {
      ...
      mockAvatarData = {
        ...
        'no-name-room-id': AvatarInfo(
          uniqueId: 'no-name-room-id',
        ),
      };
    });
    ...
    Future<void> pumpSpaceActivitiesItemWidget(
      ...
      final testActivities = activities ?? [
        MockActivity(
          mockType: 'comment',
    ...
    testWidgets('renders basic widget structure correctly', (WidgetTester tester) async {
    ...
    testWidgets('displays room name from avatar info', (WidgetTester tester) async {
    ...
    testWidgets('falls back to roomId when display name is null', (WidgetTester tester) async {
      await pumpSpaceActivitiesItemWidget(
        tester,
        roomId: 'no-name-room-id',
      );

      expect(find.text('no-name-room-id'), findsOneWidget);
    });

    testWidgets('renders single activity correctly', (WidgetTester tester) async {
    ...
    testWidgets('renders multiple activities correctly', (WidgetTester tester) async {
    ...
    testWidgets('ExpansionTile has correct properties', (WidgetTester tester) async {
      await pumpSpaceActivitiesItemWidget(tester);
    ...
    testWidgets('activity items have correct padding', (WidgetTester tester) async {
      await pumpSpaceActivitiesItemWidget(tester);

      final paddingWidgets = tester.widgetList<Padding>(find.byType(Padding));
      
      // Find padding widgets with horizontal padding of 10
    ...
    testWidgets('SizedBox has correct width between dashed line and activity', (WidgetTester tester) async {
      await pumpSpaceActivitiesItemWidget(tester);
    ...
    testWidgets('passes correct activity to ActivityItemWidget', (WidgetTester tester) async {
  ...
  group('SpaceActivitiesSkeleton Tests', () {
    ...
    testWidgets('renders skeleton widget correctly', (WidgetTester tester) async {
    ...
    testWidgets('ListView has correct properties in skeleton', (WidgetTester tester) async {
      await pumpSpaceActivitiesSkeleton(tester);
    ...
    testWidgets('skeleton renders correct number of list items', (WidgetTester tester) async {
      await pumpSpaceActivitiesSkeleton(tester);

      expect(find.byType(ListTile), findsNWidgets(5));
    });

    testWidgets('skeleton list items have correct structure', (WidgetTester tester) async {
      await pumpSpaceActivitiesSkeleton(tester);
      ...
      expect(find.text('Sub-title Sub-title Sub-title Sub-title Sub-title Sub-title Sub-title'), findsNWidgets(5));
    });

    testWidgets('skeleton icons have correct size', (WidgetTester tester) async {
      await pumpSpaceActivitiesSkeleton(tester);
