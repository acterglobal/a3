...
class MockMemberAvatarProvider extends Mock {
  MemoryImage? call(MemberInfo query) {
  ...
  Future<void> createWidgetUnderTest({
    ...
    await tester.pumpProviderWidget(
      ...
      overrides: [
        ...
        memberDisplayNameProviderInner.overrideWith((ref, query) {
          return mockMemberDisplayNameProvider.call(query);
        }),
        memberAvatarProviderInner.overrideWith((ref, query) {
