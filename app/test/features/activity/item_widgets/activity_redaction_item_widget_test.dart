...
void main() {
  Future<void> createWidgetUnderTest({
    ...
    await tester.pumpProviderWidget(
      ...
      child: Material(
        child: ActivityRedactionItemWidget(activity: mockActivity!),
      ),
    );
  ...
  testWidgets('Delete Pin Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.redaction.name,
  ...
  testWidgets('Delete event Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.redaction.name,
      mockObject: MockActivityObject(
        mockType: 'event',
  ...
  testWidgets('Delete Task-list Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.redaction.name,
      mockObject: MockActivityObject(
        mockType: 'task-list',
  ...
  testWidgets('Delete TaskItem Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.redaction.name,
      mockObject: MockActivityObject(
        mockType: 'task',
