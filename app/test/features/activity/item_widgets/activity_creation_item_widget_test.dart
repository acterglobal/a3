...
void main() {
  Future<void> createWidgetUnderTest({
    ...
    await tester.pumpProviderWidget(
      ...
      child: Material(
        child: ActivityCreationItemWidget(activity: mockActivity!),
      ),
    );
  ...
  testWidgets('Create Pin Object', (tester) async {
  ...
  testWidgets('Create event Object', (tester) async {
    MockActivity mockActivity = MockActivity(
  ...
  testWidgets('Create Task-list Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.creation.name,
      mockObject: MockActivityObject(
        mockType: 'task-list',
  ...
  testWidgets('Create TaskItem Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.creation.name,
      mockObject: MockActivityObject(
        mockType: 'task',
