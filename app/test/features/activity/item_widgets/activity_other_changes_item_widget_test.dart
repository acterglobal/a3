...
void main() {
  Future<void> createWidgetUnderTest({
    ...
    await tester.pumpProviderWidget(
      ...
      child: Material(
        child: ActivityOtherChangesItemWidget(activity: mockActivity!),
      ),
    );
  ...
  testWidgets('other changes of Pin Object', (tester) async {
  ...
  testWidgets('other changes of  event Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.otherChanges.name,
      mockObject: MockActivityObject(
        mockType: 'event',
  ...
  testWidgets('other changes of Task-list Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.otherChanges.name,
      mockObject: MockActivityObject(
        mockType: 'task-list',
  ...
  testWidgets('other changes of TaskItem Object', (tester) async {
    MockActivity mockActivity = MockActivity(
      mockType: PushStyles.otherChanges.name,
      mockObject: MockActivityObject(
        mockType: 'task',
