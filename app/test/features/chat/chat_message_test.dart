...
void main() {
  ...
  group(
    'User mention chat message parsing test -',
    () {
      test(
        'Parse massage with one instance of user mention',
        () {
          String msg =
      ...
      test(
        'Parse massage with multiple instances of different user mentions',
        () {
          String msg =
      ...
      test(
        'Parse massage with duplicate instances of user mentions',
        () {
          String msg =
  ...
  group(
    'Matrix room link parsing test -',
    () {
      test(
        'Parse private room link - With "Via home sever" details',
        () {
          //Static
          String roodIdLink =
      ...
      test(
        'Parse private room link - Without "Via home sever" details',
        () {
          String roodIdLink =
      ...
      test(
        'Parse public room link - With "#" sign at the starting of link',
        () {
      ...
      test(
        'Parse link which is other than room link',
        () {
