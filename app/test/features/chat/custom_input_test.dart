...
void main() {
  group('Custom Chat Input - General States', () {
    testWidgets('No access, no show', (tester) async {
    ...
    testWidgets('Unknown Access show Loading', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            // Same as before
    ...
    testWidgets('Show input', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            // Same as before
  ...
  group('Send button states', () {
    ...
    testWidgets('Showing and hiding send button simple', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: overrides,
          child: const InActerContextTestWrapper(
  ...
  group('Custom Chat Input - Controller states', () {
    ...
    testWidgets('Switching edit/reply stores selected message', (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: overrides,
          child: const InActerContextTestWrapper(
    ...
    testWidgets('Switching to room stores previous message state of room', (
      tester,
    ) async {
