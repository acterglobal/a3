...
class MultiTriggerAutocomplete extends StatefulWidget {
  ...
  /// A optional map of trigger symbols to their corresponding TextStyles.
  /// This allows for custom styling of different triggers
  ...
  /// {@endtemplate}
  ///
  /// required for [AutocompleteTextController].
  final FocusNode focusNode;

  /// Extended version of [TextEditingController]. This is required for
  final AutocompleteTextController textEditingController;
...
class MultiTriggerAutocompleteState extends State<MultiTriggerAutocomplete> {
  late AutocompleteTextController _textEditingController;
  ...
  void _updateTextEditingController(
      AutocompleteTextController? old, AutocompleteTextController? current) {
    ...
    if (old == null) {
      ...
      _textEditingController.removeListener(_onChangedField);
      _textEditingController = AutocompleteTextController(widget.triggerStyles);
    } else {
      _textEditingController.removeListener(_onChangedField);
      _textEditingController = current;
    }
