...
final isActerSpaceForSpace = FutureProvider.autoDispose.family<bool, Space>((
  ref,
  space,
) async {
...
class SpaceInfo extends ConsumerWidget {
  ...
  Widget skeletonUI() {
    return Skeletonizer(
      child: Row(
        children: [
          Icon(Atlas.glasses_vision_thin, size: size),
          Icon(Atlas.lock_clipboard_thin, size: size),
          Icon(Atlas.shield_exclamation_thin, size: size),
        ],
      ),
    );
  }
