    ...
    return InkWell(
      ...
      child: Card(
        ...
        child: Column(
          children: [
            ListTile(
              leading: ActerAvatar(options: AvatarOptions.DM(accountInfo)),
              title: Text(
                accountInfo.displayName ?? '',
                overflow: TextOverflow.ellipsis,
                style: Theme.of(context).textTheme.titleSmall,
              ),
              subtitle: Text(userId, overflow: TextOverflow.ellipsis),
          ...
          child: Row(
            children: [
              ...
              Column(
                ...
                children: [Text(lang.displayName), Text(lang.username)],
              ),
            ],
          ),
        ),
