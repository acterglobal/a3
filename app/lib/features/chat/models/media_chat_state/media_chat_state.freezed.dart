...
class _$MediaChatLoadingStateLoadingImpl
    implements _MediaChatLoadingStateLoading {
  const _$MediaChatLoadingStateLoadingImpl();

  @override
  String toString() {
    return 'MediaChatLoadingState.loading()';
  }
...
abstract class _MediaChatLoadingStateLoading implements MediaChatLoadingState {
  const factory _MediaChatLoadingStateLoading() =
      _$MediaChatLoadingStateLoadingImpl;
}
...
class _$MediaChatLoadingStateLoadedImpl
    implements _MediaChatLoadingStateLoaded {
  const _$MediaChatLoadingStateLoadedImpl();

  @override
  String toString() {
    return 'MediaChatLoadingState.loaded()';
  }
...
abstract class _MediaChatLoadingStateLoaded implements MediaChatLoadingState {
  const factory _MediaChatLoadingStateLoaded() =
      _$MediaChatLoadingStateLoadedImpl;
}
...
class _$MediaChatLoadingStateErrorImpl implements _MediaChatLoadingStateError {
  const _$MediaChatLoadingStateErrorImpl([this.error]);
  ...
  @override
  String toString() {
    return 'MediaChatLoadingState.error(error: $error)';
  }
...
abstract class _MediaChatLoadingStateError implements MediaChatLoadingState {
  const factory _MediaChatLoadingStateError([final String? error]) =
      _$MediaChatLoadingStateErrorImpl;
...
/// @nodoc
class _$MediaChatStateCopyWithImpl<$Res, $Val extends MediaChatState>
    implements $MediaChatStateCopyWith<$Res> {
  _$MediaChatStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
class __$$MediaChatStateImplCopyWithImpl<$Res>
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.mediaChatLoadingState, mediaChatLoadingState) ||
