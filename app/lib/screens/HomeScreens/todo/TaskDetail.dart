...
import 'package:effektio/screens/HomeScreens/todo/TaskAssign.dart';
import 'package:effektio/screens/HomeScreens/todo/TaskComments.dart';

import 'package:effektio/widgets/AppCommon.dart';
import 'package:effektio/widgets/CommentInput.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              TaskCommentScreen(listIndex: listIndex, index: index),
        ),
      ),
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 10),
