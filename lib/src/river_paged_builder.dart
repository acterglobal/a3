...
typedef PagedBuilder<PageKeyType, ItemType> = Widget Function(PagingController<PageKeyType, ItemType> controller, PagedChildBuilderDelegate<ItemType> builder);

typedef InfiniteScrollProvider<PageKeyType, ItemType> = StateNotifierProvider<PagedNotifierMixin<PageKeyType, ItemType, PagedState<PageKeyType, ItemType>>, PagedState<PageKeyType, ItemType>>;
typedef InfiniteScrollAutoDisposeProvider<PageKeyType, ItemType> = AutoDisposeStateNotifierProvider<PagedNotifierMixin<PageKeyType, ItemType, PagedState<PageKeyType, ItemType>>, PagedState<PageKeyType, ItemType>>;
...
class RiverPagedBuilder<PageKeyType, ItemType> extends ConsumerStatefulWidget {
  ...
  final InfiniteScrollAutoDisposeProvider<PageKeyType, ItemType>? _autoDisposeProvider;
  ...
  final Widget Function(BuildContext context, PagingController controller)? firstPageErrorIndicatorBuilder;
  final Widget Function(BuildContext context, PagingController controller)? firstPageProgressIndicatorBuilder;
  final Widget Function(BuildContext context, PagingController controller)? noItemsFoundIndicatorBuilder;
  final Widget Function(BuildContext context, PagingController controller)? newPageErrorIndicatorBuilder;
  final Widget Function(BuildContext context, PagingController controller)? newPageProgressIndicatorBuilder;
  final Widget Function(BuildContext context, PagingController controller)? noMoreItemsIndicatorBuilder;
  ...
  @override
  _RiverPagedBuilderState createState() => _RiverPagedBuilderState<PageKeyType, ItemType>();
}

class _RiverPagedBuilderState<PageKeyType, ItemType> extends ConsumerState<RiverPagedBuilder<PageKeyType, ItemType>> {
  ...
  void initState() {
    ...
    _pagingController = PagingController<PageKeyType, ItemType>(firstPageKey: widget.firstPageKey);
